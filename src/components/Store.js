		...
		return (
			...
			>
				<div className="inventory">
					<div><h1><b>Liste des joueurs</b></h1></div>
					<Product
						edit
						add
						{
				...
				<div className="store">
					<div><h1><b>Marché des transferts</b></h1></div>
					{
						this.props.store.items.map((item) => {
							return (
								<Product
				...
				<div className="cart">
					<div><h1><b>Joueurs obtenus</b></h1></div>
					<ul>
						{
					...
					<div>
						{
							order.length > 0 ?
								...
								>
									...
									<button
										onClick={() => this.props.store_valid_cart()} className="button1"
									>
										Valider
									</button>
								</div>
